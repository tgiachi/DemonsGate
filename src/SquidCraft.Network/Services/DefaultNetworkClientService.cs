...
public class DefaultNetworkClientService : INetworkClientService
{
    ...
    /// </summary>
    private readonly Dictionary<Guid, TaskCompletionSource<ISquidCraftMessage>> _pendingRequests = new();
    ...
    private async Task DispatchMessageToListenersAsync(ISquidCraftMessage message)
    {
        ...
        where TResponse : ISquidCraftMessage
    {
        ...
        var tcs = new TaskCompletionSource<ISquidCraftMessage>(TaskCreationOptions.RunContinuationsAsynchronously);
