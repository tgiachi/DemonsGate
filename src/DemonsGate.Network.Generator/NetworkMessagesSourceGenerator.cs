...
namespace DemonsGate.Network.Generator;
...
public class NetworkMessagesSourceGenerator : ISourceGenerator
{
    ...
    private static string GenerateNetworkMessagesUtilsClass(List<(string FullTypeName, string MessageType)> messageClasses)
    {
        ...
        sb.AppendLine("using DemonsGate.Network.Data.Services;");
        sb.AppendLine("using DemonsGate.Network.Types;");
        sb.AppendLine();
        sb.AppendLine("namespace DemonsGate.Network.Generated;");
        sb.AppendLine();
