...
public class GenerationPipelineIntegrationTests
{
    ...
    public async Task FullPipeline_ProducesVariedBiomes()
    {
        ...
        var seed = 12345;
        var biomeTypes = new HashSet<DemonsGate.Services.Game.Types.BiomeType>();
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            if (context.CustomData["BiomeData"] is DemonsGate.Services.Game.Data.BiomeData biomeData)
            {
